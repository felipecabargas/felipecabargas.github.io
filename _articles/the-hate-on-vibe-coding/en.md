...
excerpt: "AI-driven 'vibe-coding' isn't the threat people think it is — and the outrage reveals more about the industry's anxieties than any real technical risk."
readtime: "4 min read"
slug: the-hate-on-vibe-coding
---
...
While scrolling on LinkedIn, I've seen two camps emerge: one that loves vibe-coding and seems to not fully understand its value, and the other outraged by the idea of using prompting to ship production code without fully understanding what's under the hood. The criticism is often sharp: *"This is reckless. This undermines engineering discipline. This is dangerous."*
...
To me, the hate on vibe-coding and vibe-coders is just arising from developers who are either insecure about their future (and rightly so — the market is cold and the tech is moving fast) or outright against AI (this I do believe to be a problem).

## What Has Actually Changed

AI is exposing the fundamentals gap.

- Developers who understand their stack use AI to remove grunt work and accelerate delivery.
- Developers who don't understand their stack now ship broken code faster.
- Developers who understand their stack *and* use AI effectively can get the boring stuff out of the way quickly and innovate.
...
- How do we keep investing in fundamentals, so teams know when AI is helping versus when it's misleading?
